...
def exchange_lib_tables():
    with ExchangeLibDB() as m_cursor:
        ...
        m_cursor.execute(
            ...
            "`date` INT NOT NULL COMMENT '时间戳',"
            "`variety_en` VARCHAR(20) NOT NULL COMMENT '品种',"
            "`long_position` INT(11) NOT NULL DEFAULT 0 COMMENT '多单量',"
            "`long_position_increase` INT(11) NOT NULL DEFAULT 0 COMMENT '多单变化',"
            "`short_position` INT(11) NOT NULL DEFAULT 0 COMMENT '空单量',"
            "`short_position_increase` INT(11) NOT NULL DEFAULT 0 COMMENT '空单变化',"
            "`net_position` INT(11) NOT NULL DEFAULT 0 COMMENT '净空',"
            "`net_position_increase` INT(11) NOT NULL DEFAULT 0 COMMENT '净空变化',"
            "UNIQUE KEY `date`(`date`,variety_en)"
            ") DEFAULT CHARSET='utf8';"
        )
        # 品种的现货报价数据
