...
interface_api.include_router(person_router, prefix='', tags=['用户Person'])
interface_api.include_router(datalib_router, prefix='/dat', tags=["系统数据库"])
interface_api.include_router(dsas_router, prefix='/dsas', tags=['数据分析'])
interface_api.include_router(operation_router, prefix='/op', tags=['运营管理'])
